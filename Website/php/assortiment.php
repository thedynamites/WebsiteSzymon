...
?>
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` WHERE product_id = '200' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` WHERE product_id = '210' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` WHERE product_id = '220' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` WHERE product_id = '230' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` WHERE product_id = '240' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
