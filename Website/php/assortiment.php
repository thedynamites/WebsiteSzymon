...
?>
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `kindervuurwerk` WHERE product_id = '200' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `kindervuurwerk` WHERE product_id = '210' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `kindervuurwerk` WHERE product_id = '220' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `kindervuurwerk` WHERE product_id = '230' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `kindervuurwerk` WHERE product_id = '240' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `knalvuurwerk` WHERE product_id = '300' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `knalvuurwerk` WHERE product_id = '310' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `knalvuurwerk` WHERE product_id = '320' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `knalvuurwerk` WHERE product_id = '330' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `knalvuurwerk` WHERE product_id = '340' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `siervuurwerk` WHERE product_id = '400' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `siervuurwerk` WHERE product_id = '410' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `siervuurwerk` WHERE product_id = '420' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `siervuurwerk` WHERE product_id = '430' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
    ...
    $sql = "SELECT product_id, product_naam, product_prijs FROM `siervuurwerk` WHERE product_id = '440' or product_naam or product_prijs;";
    $result = mysqli_query($conn, $sql);
    $resultcheck = mysqli_num_rows($result);
