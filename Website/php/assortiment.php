...
<body>
   ...
   <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        ...
        <p class="lead font-weight-normal">Compleet assortiment</p>
      </div>
     ...
     <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
            <?php
              $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `veiligheid`  WHERE product_id = '100' or product_naam or product_prijs;";
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php
            $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `veiligheid` WHERE product_id = '110' or product_naam or product_prijs;";
            include 'includes/DB-laden.php'
         ?>
         </p>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
          <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `veiligheid` WHERE product_id = '120' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
          ?>
          </p>
          <h2 class="display-5"></h2>
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php  
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `veiligheid` WHERE product_id = '130' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
         ?>
         </p>
         <h2 class="display-5"></h2>
     ...
     <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
          <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `kindervuurwerk` WHERE product_id = '200' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
          ?>
          </p>
          <h2 class="display-5"></h2>
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php 
               $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `kindervuurwerk` WHERE product_id = '210' or product_naam or product_prijs;";
               include 'includes/DB-laden.php'
         ?>   
         </p>
         <h2 class="display-5"></h2>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
          <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `kindervuurwerk` WHERE product_id = '220' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
          ?>    
          </p>    
          <h2 class="display-5"></h2>
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php 
               $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `kindervuurwerk` WHERE product_id = '230' or product_naam or product_prijs;";
               include 'includes/DB-laden.php'
         ?>  
         </p>   
         <h2 class="display-5"></h2>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
         <p>
         <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `kindervuurwerk` WHERE product_id = '240' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
         ?>
         </p>
         <h2 class="display-5"></h2>
     ...
     <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
          <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `siervuurwerk` WHERE product_id = '400' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
          ?>    
          </p>
          <h2 class="display-5"></h2>
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `siervuurwerk` WHERE product_id = '410' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
         ?>     
         </p>   
         <h2 class="display-5"></h2>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
          <p>
          <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `siervuurwerk` WHERE product_id = '420' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
          ?>     
          </p>
          <h2 class="display-5"></h2>
      ...
      <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 p-3">
         <p>
         <?php 
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `siervuurwerk` WHERE product_id = '430' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
         ?>     
         </p>   
         <h2 class="display-5"></h2>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
        <div class="my-3 py-3">
         <p>
         <?php
                $sql = "SELECT product_id, product_naam, product_prijs FROM `compleet_assortiment` `siervuurwerk` WHERE product_id = '440' or product_naam or product_prijs;";
                include 'includes/DB-laden.php'
         ?>      
         </p>   
         <h2 class="display-5"></h2>
